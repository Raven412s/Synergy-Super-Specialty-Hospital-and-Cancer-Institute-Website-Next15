...
const AyushmaanBharatCard = () => {
  return (
    <section className="py-12 px-4 bg-gradient-to-r from-fuchsia-600 from-10%  to-synergy-blue  to-100% rounded-2xl shadow-lg mx-2 md:mx-0">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="relative flex flex-col md:flex-row justify-start items-center gap-10 md:gap-20">
          <ImageWithFallback
            fallbackSrc="/fallback-image.webp"
            src="/Ayushman-Card.png"
            width={450}
            height={400}
            alt="Ayushmaan Bharat Card"
            className="object-cover object-center w-full md:w-1/2 rounded-xl"
          />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 space-y-6">
            <h2 className="text-2xl md:text-4xl font-bold mb-4 flex items-center gap-3">
              <FaIdCardAlt className="text-white text-4xl md:text-5xl" />
          ...
          <div className="flex-1 flex justify-center">
            <div className="bg-gradient-to-tl from-white via-fuchsia-100 to-fuchsia-200 text-blue-700 p-6 md:p-8 rounded-xl shadow-md w-full max-w-sm text-center flex flex-col items-center gap-4">
              ...
              <button className="mt-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-full transition-colors text-sm md:text-base">
                Know More
              </button>
            </div>
          </div>
