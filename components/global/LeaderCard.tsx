...
export const LeaderCard: React.FC<LeaderCardProps> = ({
    ...
    return (
<Card className="h-full w-full flex flex-col justify-between bg-gradient-to-t from-slate-100 to-transparent rounded-xl shadow-md overflow-hidden !py-2 max-w-[640px]">
