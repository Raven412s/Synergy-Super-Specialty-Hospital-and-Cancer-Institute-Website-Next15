        ...
        <div className="w-full lg:w-1/3 flex flex-col space-y-6 pr-0 lg:pr-8 mb-8 lg:mb-0">
            ...
            >
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 className="font-semibold">Award-Winning Care</h3>
                        <p className="text-sm text-gray-500">Recognized nationally for excellence</p>
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Featured in leading healthcare publications</p>
                    </div>
                </div>
            </motion.div>
