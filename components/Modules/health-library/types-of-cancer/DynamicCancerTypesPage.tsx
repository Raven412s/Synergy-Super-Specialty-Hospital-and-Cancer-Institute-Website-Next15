...
import { CANCER_TYPES_DATA } from '@/data/CANCER_TYPES'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-8 text-center text-white">
                ...
                <p className="mb-6 max-w-2xl mx-auto">
                    If you or a loved one are experiencing symptoms or have been diagnosed with adrenal cancer,
                    our specialists are here to help with expert care and personalized treatment plans.
                </p>
