  ...
  const faqs = [
    {
      ...
      answer: 'Our outpatient clinics are open Monday to Saturday from 8:00 AM to 8:00 PM. Some specialty clinics may have specific hours.'
    },
    {
      question: 'How do I book an appointment?',
      answer: 'You can book online through our portal, call our appointment desk, or use the hospital mobile app.'
    },
    {
      question: 'What should I bring to my first visit?',
      answer: 'Please bring your ID, insurance information, any previous medical records, and a list of current medications.'
    },
    {
      question: 'Do I need a referral to see a specialist?',
      answer: 'Most specialty clinics accept direct appointments, but some insurance plans may require a referral.'
    }
  ];
